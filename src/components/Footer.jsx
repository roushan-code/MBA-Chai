...
const Footer = () => {
    const footerLinks =(element)=>{
        ...
        case 2:
            ...
            break;
        case 3:
            allFooterLinks.forEach((
                item, index)=>index===3 ? (item.style.opacity = 1) : (item.style.opacity = 0.2) ); 
            break;
        case 4:
        ...
        <>
            <footer>
                ...
                <div>
                    ...
                    <a href="mailto: franchise@mbachaiwala.com" >Frenchise@mbachaiwala.com</a>
                </div>
